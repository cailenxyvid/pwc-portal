...
<div class="block rounded-lg card card-hover ">    
    ...
    <div class="card-footer">
        {#if showHover}
        <div class="absolute h-36 w-full rounded-sm bg-[#dedede] p-4 overflow-hidden z-[999]">
        ...
        {/if}
        <div class="text-right grow align-bottom bottom-0  w-full pr-4 pb-2">
