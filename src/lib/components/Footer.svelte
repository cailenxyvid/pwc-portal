...
<div class="bg-[#2d2d2d] text-white p-8 md:px-12">
	<div class="flex flex-col container mx-auto">
		...
		<div class="flex flex-row flex-wrap mb-16 gap-4 lg:gap-16 xl:gap-32">
			<div>
				<div class="text-xl block">Jonathan Block</div>
				Managing Director, PwC’s Trust Leadership Institute
			</div>
			<div>
				<div class="text-xl block">Megan Conway</div>
				Managing Director, PwC’s Trust Leadership Institute
			</div>
		</div>
		<h3 class="mb-4">
		...
		<div class="text-xs">
			...
			the PwC network. Each member firm is a separate legal entity. Please see www.pwc.com/structure
			for further details. This content is for general purposes only, and should not be used as a
